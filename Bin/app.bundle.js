...
/***/ "./Engine/HTMLHelpers/CreateElement.ts":
/*!*********************************************!*\
  !*** ./Engine/HTMLHelpers/CreateElement.ts ***!
  \*********************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"MainView\", function() { return MainView; });\n/* harmony import */ var _GameSelection__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./GameSelection */ \"./Engine/Views/GameSelection.ts\");\n/* harmony import */ var _Game__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Game */ \"./Engine/Views/Game.ts\");\n/* harmony import */ var _GameUpload__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./GameUpload */ \"./Engine/Views/GameUpload.ts\");\n/* harmony import */ var _Services_LoadStaticGame__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Services/LoadStaticGame */ \"./Engine/Services/LoadStaticGame.ts\");\n/* harmony import */ var _Services_LocalStorage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Services/LocalStorage */ \"./Engine/Services/LocalStorage.ts\");\n/* harmony import */ var _Services_GameStorage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Services/GameStorage */ \"./Engine/Services/GameStorage.ts\");\n/* harmony import */ var _Container__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Container */ \"./Engine/Views/Container.ts\");\n/* harmony import */ var _Slot__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Slot */ \"./Engine/Views/Slot.ts\");\n/* harmony import */ var _Section__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Section */ \"./Engine/Views/Section.ts\");\n/* harmony import */ var _TabsView__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./TabsView */ \"./Engine/Views/TabsView.ts\");\n/* harmony import */ var _JSON__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./JSON */ \"./Engine/Views/JSON.ts\");\n/* harmony import */ var _GameStateStore__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./GameStateStore */ \"./Engine/Views/GameStateStore.ts\");\n/* harmony import */ var _Button__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./Button */ \"./Engine/Views/Button.ts\");\n/* harmony import */ var _download_file__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../download-file */ \"./Engine/download-file.ts\");\n/* harmony import */ var _GameHistory__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./GameHistory */ \"./Engine/Views/GameHistory.ts\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nclass MainView {\r\n    constructor(loader) {\r\n        this.wasMounted = false;\r\n        this.staticGamesConfig = null;\r\n        this.handleGameUpload = (name, game) => {\r\n            const response = this.gamesStorage.addGame(name, game);\r\n            if (response.status === 'error') {\r\n                return response;\r\n            }\r\n            this.selectGame(name, game);\r\n            const gameSelection = this.root.content.menu.content.content;\r\n            if (gameSelection != null) {\r\n                const staticGames = this.staticGamesConfig != null ? this.staticGamesConfig.gameFolders : [];\r\n                gameSelection.options = staticGames.concat(this.gamesStorage.getGameNames());\r\n                gameSelection.value = name;\r\n            }\r\n            return response;\r\n        };\r\n        this.JSONViewInput = new _JSON__WEBPACK_IMPORTED_MODULE_10__[\"JSONView\"]({\r\n            version: '2',\r\n            sprites: {},\r\n            components: []\r\n        }, newConfig => {\r\n            this.gameConfig = newConfig;\r\n            if (this.gameStateContainer != null) {\r\n                this.gameStateContainer.addState(newConfig.components, 'changed_in_json_editor');\r\n            }\r\n        }, 'game-state-json-editor');\r\n        this.root = new _Container__WEBPACK_IMPORTED_MODULE_6__[\"ContainerView\"]({\r\n            menu: new _Section__WEBPACK_IMPORTED_MODULE_8__[\"SectionView\"]('Select game', new _Slot__WEBPACK_IMPORTED_MODULE_7__[\"SlotView\"]('main-menu-slot', null), 'select-game-section'),\r\n            center: new _Container__WEBPACK_IMPORTED_MODULE_6__[\"ContainerView\"]({\r\n                gameSlot: new _Slot__WEBPACK_IMPORTED_MODULE_7__[\"SlotView\"]('game-view-slot', null)\r\n            }),\r\n            rightMenu: new _TabsView__WEBPACK_IMPORTED_MODULE_9__[\"TabsView\"]({\r\n                history: {\r\n                    name: 'Moves History',\r\n                    content: new _Slot__WEBPACK_IMPORTED_MODULE_7__[\"SlotView\"]('game-history-slot', null)\r\n                },\r\n                saveLoad: {\r\n                    name: 'Game State',\r\n                    content: new _Container__WEBPACK_IMPORTED_MODULE_6__[\"ContainerView\"]({\r\n                        buttons: new _Container__WEBPACK_IMPORTED_MODULE_6__[\"ContainerView\"]({\r\n                            save: new _Button__WEBPACK_IMPORTED_MODULE_12__[\"ButtonView\"]('Save', () => Object(_download_file__WEBPACK_IMPORTED_MODULE_13__[\"downloadJsonFile\"])(`${this.gameName}.json`, JSON.stringify(this.gameConfig, null, 2)))\r\n                        }, 'safe-load-buttons'),\r\n                        editor: this.JSONViewInput,\r\n                    })\r\n                },\r\n                uploadGame: {\r\n                    name: 'Upload Game',\r\n                    content: new _GameUpload__WEBPACK_IMPORTED_MODULE_2__[\"GameUploadView\"](this.handleGameUpload)\r\n                },\r\n            }, 'history', 'right-menu-tabs')\r\n        }, 'main-view');\r\n        this.gameName = null;\r\n        this.gameConfig = null;\r\n        this.gameStateContainer = null;\r\n        const localStorage = new _Services_LocalStorage__WEBPACK_IMPORTED_MODULE_4__[\"LocalStorage\"]('board-game');\r\n        this.gamesStorage = new _Services_GameStorage__WEBPACK_IMPORTED_MODULE_5__[\"GameStorage\"](localStorage);\r\n        loader\r\n            .loadJSON('games.json')\r\n            .then(gamesConfig => {\r\n            const gameSelection = new _GameSelection__WEBPACK_IMPORTED_MODULE_0__[\"GameSelectionView\"](gamesConfig.gameFolders.concat(this.gamesStorage.getGameNames()), gameId => {\r\n                const customGame = this.gamesStorage.getGame(gameId);\r\n                if (customGame != null) {\r\n                    this.selectGame(gameId, customGame);\r\n                }\r\n                else if (gamesConfig.gameFolders.indexOf(gameId) !== -1) {\r\n                    Object(_Services_LoadStaticGame__WEBPACK_IMPORTED_MODULE_3__[\"loadStaticGame\"])(loader, gameId).then(game => this.selectGame(gameId, game));\r\n                }\r\n            });\r\n            this.root.content.menu.content.content = gameSelection;\r\n            const firstGameName = gamesConfig.gameFolders[0];\r\n            gameSelection.value = firstGameName;\r\n            if (firstGameName == null) {\r\n                throw new Error(`No games found in games.json`);\r\n            }\r\n            Object(_Services_LoadStaticGame__WEBPACK_IMPORTED_MODULE_3__[\"loadStaticGame\"])(loader, firstGameName).then(game => this.selectGame(firstGameName, game));\r\n        });\r\n    }\r\n    mounted() {\r\n        this.wasMounted = true;\r\n        const game = this.root.content.center.content.gameSlot.content;\r\n        if (game != null) {\r\n            game.mounted();\r\n        }\r\n    }\r\n    selectGame(name, game) {\r\n        this.gameName = name;\r\n        this.gameStateContainer = new _GameStateStore__WEBPACK_IMPORTED_MODULE_11__[\"GameStateContainer\"](game.config.components);\r\n        this.gameConfig = game.config;\r\n        this.gameStateContainer.state.bind(components => {\r\n            if (this.gameConfig != null) {\r\n                this.JSONViewInput.setValue(Object.assign({}, this.gameConfig, { components }));\r\n            }\r\n        });\r\n        const gameView = new _Game__WEBPACK_IMPORTED_MODULE_1__[\"GameView\"](name, game, this.gameStateContainer);\r\n        this.historyView = new _GameHistory__WEBPACK_IMPORTED_MODULE_14__[\"GameHistoryView\"](this.gameStateContainer);\r\n        this.root.content.rightMenu.tabs.history.content.content = this.historyView;\r\n        this.root.content.center.content.gameSlot.content = gameView;\r\n        if (this.wasMounted) {\r\n            gameView.mounted();\r\n        }\r\n    }\r\n    get element() {\r\n        return this.root.element;\r\n    }\r\n    destroy() {\r\n        this.root.destroy();\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./Engine/Views/Main.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"PieceContainerView\", function() { return PieceContainerView; });\n/* harmony import */ var _Container__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Container */ \"./Engine/Views/Container.ts\");\n/* harmony import */ var _Button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Button */ \"./Engine/Views/Button.ts\");\n/* harmony import */ var _Label__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Label */ \"./Engine/Views/Label.ts\");\n\r\n\r\n\r\nclass PieceContainerView {\r\n    constructor(root, backgroundSprite, containerConfig, _itemsCount, onShuffle, onReset) {\r\n        this.root = root;\r\n        this.backgroundSprite = backgroundSprite;\r\n        this.containerConfig = containerConfig;\r\n        this._itemsCount = _itemsCount;\r\n        this.onShuffle = onShuffle;\r\n        this.onReset = onReset;\r\n        this.controls = new _Container__WEBPACK_IMPORTED_MODULE_0__[\"ContainerView\"]({\r\n            reset: new _Button__WEBPACK_IMPORTED_MODULE_1__[\"ButtonView\"]('reset', () => this.onReset()),\r\n            shuffle: new _Button__WEBPACK_IMPORTED_MODULE_1__[\"ButtonView\"]('shuffle', () => this.onShuffle())\r\n        }, 'piece-container-view__controls', {\r\n            pointerdown: e => e.stopPropagation(),\r\n            pointerup: e => e.stopPropagation()\r\n        });\r\n        this.container = new _Container__WEBPACK_IMPORTED_MODULE_0__[\"ContainerView\"]({\r\n            itemsCountLabel: new _Label__WEBPACK_IMPORTED_MODULE_2__[\"LabelView\"](this.getItemsLabel(this._itemsCount), 'piece-container-view__items-count-label'),\r\n            sprite: this.backgroundSprite,\r\n            controls: this.controls\r\n        }, 'piece-container-view');\r\n    }\r\n    get containerComponent() {\r\n        return this.containerConfig;\r\n    }\r\n    set itemsCount(newValue) {\r\n        this.container.content.itemsCountLabel.text = `${newValue} items`;\r\n    }\r\n    getItemsLabel(count) {\r\n        return `${count} items`;\r\n    }\r\n    get element() {\r\n        return this.container.element;\r\n    }\r\n    destroy() {\r\n        this.container.destroy();\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./Engine/Views/PieceContainer.ts?");

/***/ }),

/***/ "./Engine/Views/Section.ts":
/*!*********************************!*\
  !*** ./Engine/Views/Section.ts ***!
  \*********************************/
/*! exports provided: SectionView */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"SectionView\", function() { return SectionView; });\n/* harmony import */ var _Container__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Container */ \"./Engine/Views/Container.ts\");\n/* harmony import */ var _Label__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Label */ \"./Engine/Views/Label.ts\");\n/* harmony import */ var _Slot__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Slot */ \"./Engine/Views/Slot.ts\");\n\r\n\r\n\r\nclass SectionView {\r\n    constructor(name, _content, className) {\r\n        this.name = name;\r\n        this._content = _content;\r\n        this.className = className;\r\n        this.root = new _Container__WEBPACK_IMPORTED_MODULE_0__[\"ContainerView\"]({\r\n            header: new _Label__WEBPACK_IMPORTED_MODULE_1__[\"LabelView\"](this.name, 'section-view__name'),\r\n            contentSlot: new _Slot__WEBPACK_IMPORTED_MODULE_2__[\"SlotView\"]('content-view__content', this._content)\r\n        }, [this.className, 'section-view']);\r\n    }\r\n    get content() {\r\n        return this.root.content.contentSlot.content;\r\n    }\r\n    set content(content) {\r\n        this.root.content.contentSlot.content = content;\r\n    }\r\n    get element() {\r\n        return this.root.element;\r\n    }\r\n    mounted() {\r\n        if (this._content.mounted != null) {\r\n            this._content.mounted();\r\n        }\r\n    }\r\n    destroy() {\r\n        this.root.destroy();\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./Engine/Views/Section.ts?");

/***/ }),

/***/ "./Engine/Views/Slot.ts":
/*!******************************!*\
  !*** ./Engine/Views/Slot.ts ***!
  \******************************/
/*! exports provided: SlotView */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"SlotView\", function() { return SlotView; });\n/* harmony import */ var _HTMLHelpers_CreateElement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../HTMLHelpers/CreateElement */ \"./Engine/HTMLHelpers/CreateElement.ts\");\n\r\nclass SlotView {\r\n    constructor(className = null, currentContent) {\r\n        this.className = className;\r\n        this.currentContent = null;\r\n        this.root = Object(_HTMLHelpers_CreateElement__WEBPACK_IMPORTED_MODULE_0__[\"createElement\"])('div', ['slot-view', this.className]);\r\n        this.content = currentContent;\r\n    }\r\n    set content(content) {\r\n        this.destroyContent();\r\n        this.currentContent = content;\r\n        if (content == null) {\r\n            return;\r\n        }\r\n        this.root.appendChild(content.element);\r\n    }\r\n    get content() {\r\n        return this.currentContent;\r\n    }\r\n    destroyContent() {\r\n        if (this.currentContent == null) {\r\n            return;\r\n        }\r\n        this.root.removeChild(this.currentContent.element);\r\n        this.currentContent.destroy();\r\n    }\r\n    get element() {\r\n        return this.root;\r\n    }\r\n    destroy() {\r\n        this.destroyContent();\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./Engine/Views/Slot.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"SpriteView\", function() { return SpriteView; });\nclass SpriteView {\r\n    constructor(imageURL, config, name) {\r\n        this._visible = true;\r\n        this.image = document.createElement('div');\r\n        this.image.classList.add('sprite-view');\r\n        this.image.setAttribute('data-sprite-name', name);\r\n        const s = this.image.style;\r\n        s.backgroundImage = `url(\"${imageURL}\")`;\r\n        s.backgroundPosition = `${-config.x}px ${-config.y}px`;\r\n        s.width = `${config.width}px`;\r\n        s.height = `${config.height}px`;\r\n    }\r\n    get element() {\r\n        return this.image;\r\n    }\r\n    destroy() {\r\n    }\r\n    set visible(newValue) {\r\n        this.image.style.display = newValue ? 'block' : 'none';\r\n        this._visible = newValue;\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./Engine/Views/Sprite.ts?");

/***/ }),

/***/ "./Engine/Views/TabsView.ts":
/*!**********************************!*\
  !*** ./Engine/Views/TabsView.ts ***!
  \**********************************/
/*! exports provided: TabsView */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"TabsView\", function() { return TabsView; });\n/* harmony import */ var _HTMLHelpers_CreateElement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../HTMLHelpers/CreateElement */ \"./Engine/HTMLHelpers/CreateElement.ts\");\n/* harmony import */ var _Button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Button */ \"./Engine/Views/Button.ts\");\n\r\n\r\nclass TabsView {\r\n    constructor(tabs, _currentTab, className) {\r\n        this.tabs = tabs;\r\n        this._currentTab = _currentTab;\r\n        this.className = className;\r\n        this.root = Object(_HTMLHelpers_CreateElement__WEBPACK_IMPORTED_MODULE_0__[\"createElement\"])('div', ['tabs-view', this.className]);\r\n        this.tabHeadersWrapper = Object(_HTMLHelpers_CreateElement__WEBPACK_IMPORTED_MODULE_0__[\"createElement\"])('div', ['tabs-view__tab-headers']);\r\n        this.tabsWrapper = Object(_HTMLHelpers_CreateElement__WEBPACK_IMPORTED_MODULE_0__[\"createElement\"])('div', ['tabs-view__tabs']);\r\n        this.tabHeaders = Object\r\n            .keys(this.tabs)\r\n            .map(key => new _Button__WEBPACK_IMPORTED_MODULE_1__[\"ButtonView\"](this.tabs[key].name, () => this.currentTab = key, 'tabs-view__tab-header'));\r\n        this.currentTab = _currentTab;\r\n        this.root.appendChild(this.tabHeadersWrapper);\r\n        this.root.appendChild(this.tabsWrapper);\r\n        this.tabHeaders.forEach(h => this.tabHeadersWrapper.appendChild(h.element));\r\n        Object\r\n            .keys(this.tabs)\r\n            .forEach(key => this.tabsWrapper.appendChild(this.tabs[key].content.element));\r\n    }\r\n    set currentTab(tab) {\r\n        Object\r\n            .keys(this.tabs)\r\n            .forEach(key => this.tabs[key].content.element.style.display = 'none');\r\n        this.tabs[tab].content.element.style.display = '';\r\n        this.tabHeaders.forEach(t => t.element.classList.remove('tabs-view__tab-header--selected'));\r\n        this.tabHeaders[Object.keys(this.tabs).indexOf(tab)].element.classList.add('tabs-view__tab-header--selected');\r\n    }\r\n    get element() {\r\n        return this.root;\r\n    }\r\n    destroy() {\r\n        this.tabHeaders.forEach(b => b.destroy());\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./Engine/Views/TabsView.ts?");
